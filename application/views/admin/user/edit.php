...
<?php echo form_open(base_url('admin/user/edit/'.$user->id_user)); ?>
<div class="row">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group form-floating-label group-lg">
          <input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required="" name="nama" value="<?php echo $user->nama ?>" >
          <label for="inputFloatingLabel" class="placeholder">Nama Lengkap</label>
          <?php echo form_error('nama','<small class="text-danger" >','</small>') ?>
        </div>
				
				<div class="form-group form-floating-label">
					<input id="inputFloatingLabel" type="email" class="form-control input-border-bottom" required="" name="email" value="<?php echo $user->email ?>">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" required="" name="username" value="<?php echo $user->username ?>"  readonly disabled>
        </div>
        ...
        <div class="form-group form-floating-label">
					<select class="form-control " id="selectFloatingLabel2" name="id_level" required="">
						...
						<option value="<?php echo $lvl->id_level ?>" <?php echo set_select('level', $user->id_level, ($lvl->kode_level == $user->id_level)) ?>>
							<?php echo $lvl->level ?>
						</option>
						<?php }?>
					</select>
