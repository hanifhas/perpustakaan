    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group form-floating-label group-lg">
          <input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required="" name="judul" value="<?php echo $usulan->judul ?>" >
        ...
        <div class="form-group form-floating-label group-lg">
					<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required="" name="penulis" value="<?php echo $usulan->penulis ?>" >
          <label for="inputFloatingLabel" class="placeholder">Nama Penulis</label>
          <?php echo form_error('nama','<small class="text-danger" >','</small>') ?>
				</div>
				
				<div class="form-group form-floating-label group-lg">
					<input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required="" name="penerbit" value="<?php echo $usulan->penerbit ?>" >
          <label for="inputFloatingLabel" class="placeholder">penerbit</label>
          <?php echo form_error('nama','<small class="text-danger" >','</small>') ?>
				</div>
				
				<div class="form-group form-floating-label group-lg">
          <input id="inputFloatingLabel" type="text" class="form-control input-border-bottom" required="" name="nama_pengusul" value="<?php echo $usulan->nama_pengusul ?>" >
          <label for="inputFloatingLabel" class="placeholder">Nama Pengusul</label>
          <?php echo form_error('nama','<small class="text-danger" >','</small>') ?>
				</div>
				
				<div class="form-group form-floating-label">
					<input id="inputFloatingLabel" type="email" class="form-control input-border-bottom" required="" name="email_pengusul" value="<?php echo $usulan->email_pengusul ?>">
        ...
        <div class="form-group form-floating-label">
					<select class="form-control " id="selectFloatingLabel2" name="status_usulan" required="">
						<option value="">&nbsp;</option>
						<option value="Diterima" <?php if($usulan->status_usulan =="Diterima"){ echo "selected";} ?>>Diterima</option>
				...
				<div class="form-group form-floating-label">
					<textarea id="inputFloatingLabel" class="form-control input-border-bottom" rows="5" name="keterangan"><?php echo $usulan->judul ?></textarea>
